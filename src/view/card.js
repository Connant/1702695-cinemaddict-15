...
export const createMovieCardTemplate = (card) => {
  ...
  <p class="film-card__rating">${movieInfo.rating}</p>
    ...
    <p class="film-card__description">${movieInfo.description.length < MAX_LENGTH_DESCRIPTION ? movieInfo.description : `${movieInfo.description.slice(0, MAX_LENGTH_DESCRIPTION)}...`}</p>
